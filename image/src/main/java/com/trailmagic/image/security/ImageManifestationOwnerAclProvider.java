 ...
 **/
public class ImageManifestationOwnerAclProvider extends OwnerAclProvider {
    private static Logger s_log =
        LoggerFactory.getLogger(ImageManifestationOwnerAclProvider.class);
    /**
    ...
    public boolean supports(Object domainInstance) {
        ...
        boolean isSupported =
            ImageManifestation.class.isAssignableFrom(domainInstance.getClass());
    ...
    protected Object getParent(Owned ownedObj) {
        ImageManifestation manifestation = (ImageManifestation) ownedObj;
        return manifestation.getImage();
    }
}